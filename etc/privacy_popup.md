...
## html
```html
<div class="pri_pop_wrap pri_pop">
	<div class="pop_box_wrap">
		<button class="pop_x_btn" type="button">
			내용닫기
		</button>
		<div class="pop_box">
			<div class="txt" data-lenis-prevent>
				<p>본 사이트(이하 "회사"라 한다)는
...
ο 마케팅 및 광고에 활용
ο 접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계
...
신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년 (신용정보의 이용 및 보호에 관한 법률)</p></div><!-- txt -->
		</div><!-- pop_box -->
	</div>
</div><!-- pri_pop_wrap -->

<div class="pri_pop_wrap use_pop">
	<div class="pop_box_wrap">
		<button class="pop_x_btn" type="button">
			내용닫기
		</button>
...
부 칙
(시행일) 이 약관은 OOOO년 OO월 OO일부터 시행합니다.</div><!-- txt -->
		</div><!-- pop_box -->
	</div>
</div><!-- pri_pop_wrap -->
```
...
$('.pri_pop_wrap .pop_x_btn').click(function(){
	$('.pri_pop_wrap').fadeOut();
